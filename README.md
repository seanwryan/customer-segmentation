...
1. **Target Variable Distribution:**
   ...
   - ![Target Variable Distribution](/customer-segmentation/plots/Target Variable Distribution.png)
...
2. **Correlation Matrix:**
   ...
   - ![Correlation Matrix](./customer-segmentation/plots/Correlation Matrix.png)

3. **Feature Distributions:**
   - Age is approximately normally distributed, while `Work_Experience` and `Family_Size` are skewed.
   - ![Feature Distributions](./customer-segmentation/plots/Feature Distributions.png)
...
- **Cluster Distribution:**
  ...
  - ![Cluster Distribution](/customer-segmentation/plots/Cluster Distribution (KMeans).png)
